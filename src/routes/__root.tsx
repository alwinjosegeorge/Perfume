...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Voguish Moments — Elegance in every drop | Premium Perfumes in Kerala" },
      { name: "description", content: "Voguish Moments offers premium luxury perfumes and long-lasting signature fragrance oils in Kerala, India. Elegance in every drop — beauty that feels as good as it looks." },
      ...
      { property: "og:title", content: "Voguish Moments — Elegance in every drop | Premium Perfumes in Kerala" },
      { property: "og:description", content: "Discover premium luxury perfumes and long-lasting signature fragrance oils from Voguish Moments." },
